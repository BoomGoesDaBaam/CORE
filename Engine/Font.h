...
class Font
{
	...
	//Graphics& gfx;
public:
	Font(std::string filename, Color chroma, int nRaws, int nColoms, int charWidth, int charHeight, char first, char last, float distBetwCharFactor);
	Font(std::string filename, Color chroma, int charHeight, char first, char last, Color delimiter, Color newLine, float distBetwCharFactor);
